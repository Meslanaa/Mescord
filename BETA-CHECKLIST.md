...
Ana plan dosyasi (guncel): BETA-CHECKLIST-V3.md
V8 odakli onceki plan dosyasi: BETA-CHECKLIST-V2.md
...
- [x] Moderasyon paneli (mute all + user kick + room lock tamamlandi).
- [x] Hesap sistemi + arkadas listesi + DM + grup MVP (V8 foundation).
...
- [x] Graceful room restore (son oda geri don akisi eklendi).
...
- Oda sahibi icin room lock kontrolu eklendi ve kilit durumu tum odaya senkronlandi.
- Son oda geri don aksiyonu (graceful room restore) eklendi.
- v1.1.0-beta.7 release'i yayinlandi (silent update + room lock + restore).
- V8 foundation: social API (auth/friends/groups/dm) + Social Hub V2 landing paneli eklendi.
- V9 icin Discord parity + premium tasarim/animasyon hedefini iceren BETA-CHECKLIST-V3 olusturuldu.
- v1.1.0-beta.10 hotfix yayinlandi (desktop CORS/register/join fixes + runtime baglanti URL ayari + install-dir preserve update mode).
